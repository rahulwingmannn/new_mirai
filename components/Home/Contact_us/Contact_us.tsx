...
export default function ContactForm() {
  ...
  useEffect(() => {
    ...
    // Show ContactForm only when near bottom of page
    const handleScroll = () => {
  ...
  const formContent = (
    <div
      className="rounded-2xl p-8 md:p-10 border border-white/30"
      style={{
        width: '383px',
    ...
    >
      ...
      <div className="space-y-6">
        <label className="block cursor-pointer">
          <input
            placeholder="Name"
            className="w-full px-0 py-3 border-b border-gray-400/50 outline-none bg-transparent transition-colors placeholder:text-[#8B4A5E] placeholder:opacity-100 text-gray-800 focus:border-[#8B4A5E] cursor-pointer"
